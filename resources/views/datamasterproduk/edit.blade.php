                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                            <select class="choices form-select" name="bidang" required>
                                <option value="{{$produk[0]->idbidang}}" selected>{{$produk[0]->namabidang}}</option>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deskripsi" required>{{$produk[0]->deskripsi_produk}}</textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        name="harga"
                        id="harga"
                        value="{{number_format($produk[0]->harga_produk,0,'','.')}}"
