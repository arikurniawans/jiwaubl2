...
<section class="content">
		...
		<a href="{{route('/profil/create')}}" class="btn btn-flat btn-primary float-sm-right">
				<i class="fa fa-plus" aria-hidden="true"></i> Daftarkan Operator baru
		</a><br/></br>
      <!-- Default box -->
             ...
             <table id="tabeldata" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>     
                          ...
                          <!--<a href="{{route($breadcrumb[1]['url'])}}/akses/{{ base64_encode($data->id) }}" class="btn btn-flat btn-warning btn-xs">Setting Akses</a>-->
