        ...
        <div class="card-body">
          @csrf
      			...
      			<div class="form-group">
      				...
      				<input type="text" class="form-control" name="nama" required id="exampleInputEmail1" placeholder="Ketikan Nama Operator">
      			</div>
      			<div class="form-group">
                ...
                <div class="form-group">
      				...
      				<input type="email" class="form-control" name="email" required id="exampleInputEmail1" placeholder="Ketikan Email Operator">
      			</div>
      			<div class="form-group">
      				<label for="exampleInputEmail1">No. HP</label>
      				<input type="text" class="form-control" name="nohp" required id="exampleInputEmail1" placeholder="Ketikan No. Handphone">
      			</div>
      			<!-- <div class="form-group">
      				<label for="exampleInputEmail1">Hak Akses</label>
      				<select class="form-control select2" name="hakakses" style="width: 100%;" required>
    					<option selected="selected" value="" disabled>Pilih Hak Akses</option>
      			...
      			<div class="form-group">
      				<label>Alamat Operator</label>
      				<textarea class="form-control" name="alamat" required rows="3" placeholder="Ketikan Alamat Operator"></textarea>
      			</div>
      			<hr/>
