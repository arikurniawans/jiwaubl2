                ...
                <table class="table table-striped" id="table1">
                  ...
                  @foreach($datajasa as $data)
                    <tr>
                      ...
                      @if($data->status_inovasi == 2)<a href="{{route('masterjasa')}}/edit/{{ base64_encode($data->id_inovasi) }}" class="btn btn-sm btn-info">Edit</a>@endif
                      ...
                      <a href="{{route('masterjasa')}}/revision/{{ base64_encode($data->id_inovasi) }}" class="btn @if($data->status_inovasi == 1 || $data->status_inovasi == 3) disabled @endif btn-sm btn-warning">Perbaikan</a>
                      <a href="{{route('masterjasa')}}/rejected/{{ base64_encode($data->id_inovasi) }}" class="btn @if($data->status_inovasi == 1 || $data->status_inovasi == 3) disabled @endif btn-sm btn-danger">Tolak</a>
                      @endif  
                    </td>                      
                    </tr>
                      ...
                      >
                        ...
                        >
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                            <form method="post" action="{{route('masterjasa/publish')}}" enctype="multipart/form-data">
                            @csrf
                              <p>
                                Data inovasi (jasa) yang telah di publish akan tayang pada laman E-commerce JIWAUBL. Pastikan
